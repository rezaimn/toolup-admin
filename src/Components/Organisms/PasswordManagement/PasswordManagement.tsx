...
import { CheckPasswordForm } from 'Components/Organisms/CheckPasswordForm';
/* helpers */
/* assets */
/* styles */
...
/* types */
export type CommonPasswordManagementProps = {};
export type PasswordManagementProps = Omit<
    ComponentPropsWithoutRef<'div'>,
    keyof CommonPasswordManagementProps
> &
    CommonPasswordManagementProps;

export const PasswordManagement: FC<PasswordManagementProps> = ({
    className,
    ...restProps
}) => {
