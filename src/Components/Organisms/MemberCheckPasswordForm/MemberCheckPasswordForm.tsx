...
/* types */
export type CommonMemberCheckPasswordFormProps = {
    setIsModalVisible: (value: boolean) => void;
    getSecretKey: (data: string) => void;
    secretKey?: string;
}
export type MemberCheckPasswordFormProps = Omit<ComponentPropsWithoutRef<'div'>,
    keyof CommonMemberCheckPasswordFormProps
> &
    CommonMemberCheckPasswordFormProps;

export const MemberCheckPasswordForm: FC<MemberCheckPasswordFormProps> = ({ className, setIsModalVisible, getSecretKey, secretKey, ...restProps }) => {
